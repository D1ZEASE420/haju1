...
const breadcrumbs = [
    ...
    { title: 'Muuda postitust', href: `/blogs/${props.blog.id}/edit` },
];
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 max-w-2xl mx-auto">
            ...
            <div class="mb-8">
                <h1 class="text-2xl font-semibold tracking-tight text-foreground">Muuda postitust</h1>
                <p class="text-muted-foreground text-sm mt-1">Uuenda oma blogi postitust</p>
            </div>
